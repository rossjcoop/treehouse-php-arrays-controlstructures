  ...
  if ($finalAverage < .70) {
    ...
    switch ($currentGrade) {
      case 9:
        ...
        break;
      case 10:
        $messageBody = "Congratulations on completing your sophomore year in High School!\nWe’ll see you on September 1st for the start of your junior year!";
        break;
      case 11:
        $messageBody = "Congratulations on completing your junior year in High School!\nWe’ll see you on September 1st for the start of your senior year!";
        break;
      case 12:
        $messageBody = "Congratulations! You’ve graduated High School!\nDon’t forget to come back and visit.";
        break;
      default:
